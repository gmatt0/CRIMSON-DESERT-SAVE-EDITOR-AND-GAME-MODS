...
def parse_bitmapposition_entry(data, pos):
    """Auto-generated parser for bitmapposition entries."""
    entry = {}
    ...
    entry['field_38'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    ...
    entry['field_50'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_51'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    ...
    entry['field_79'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_80'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_81'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    ...
    entry['field_93'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_94'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_95'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_96'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_97'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    ...
    entry['field_108'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    ...
    entry['field_123'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    ...
    entry['field_134'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_135'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_136'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_137'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_138'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_139'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    ...
    entry['field_147'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_148'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_149'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_150'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_151'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_152'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    ...
    entry['field_161'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_162'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_163'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_164'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_165'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_166'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_167'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    ...
    entry['field_175'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_176'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_177'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_178'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_179'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_180'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    entry['field_181'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
    ...
    entry['field_194'] = struct.unpack_from('<f', data, pos)[0]; pos += 4
