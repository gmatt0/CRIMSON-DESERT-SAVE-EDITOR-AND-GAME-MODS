...
def parse_elementalmaterialinfo_entry(data, pos):
    """Auto-generated parser for elementalmaterialinfo entries."""
    entry = {}
    ...
    entry['field_22'] = struct.unpack_from('<H', data, pos)[0]; pos += 2
